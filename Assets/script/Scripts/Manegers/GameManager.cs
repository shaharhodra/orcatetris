...
public class GameManager : Singleton<GameManager>
{
    ...
    public void StartAdventureGameFromLobby()
    {
        ...
        Debug.Log($"GameManager -> StartAdventureGameFromLobby called. CurrentGameMode={CurrentGameMode}, loading scene buildIndex={classicGameSceneBuildIndex}");
        SceneManager.LoadScene(classicGameSceneBuildIndex);
    }
    ...
    private void HandleSceneLoaded(Scene scene, LoadSceneMode mode)
    {
        ...
        int index = Mathf.Max(0, HighestUnlockedLevel - 1);
